...
public class Carrera {
    ...
    Participante p1 = new Participante("Diamanete", "Carlos", (byte) 1, true, (byte)1);
    ...
    Participante p6 = new Participante("Esmeralda", "Miguel", (byte)5, false ,(byte)3);
    ...
    public void pasoPivote(List<Participante> equipo){
        for (Participante c2 : equipo) {
            ...
            }if(c2.getCorredor() == 3 && c2.isBandera() == true){
                ganador = ganador + c2.getNombreEquipo();
            }  
        }
    }
